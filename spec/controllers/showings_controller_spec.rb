  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved showing as @showing" do
        ...
        post :create, {:showing => { "location" => "invalid value" }}, valid_session
        assigns(:showing).should be_a_new(Showing)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested showing" do
        ...
        Showing.any_instance.should_receive(:update).with({ "location" => "MyString" })
        put :update, {:id => showing.to_param, :showing => { "location" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the showing as @showing" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Showing.any_instance.stub(:save).and_return(false)
        put :update, {:id => showing.to_param, :showing => { "location" => "invalid value" }}, valid_session
        assigns(:showing).should eq(showing)
      end
